...
const PaymentForm = ({ onPaymentSubmit }) => {
  ...
  const handleSubmit = (event) => {
    ...
    let paymentDetails = { card_number: cardNumber, name, payment_amount, payment_date: moment().format('DDMMYYY') }
  ...
  return (
    <div className="overflow-y-auto max-h-100">
      <div className="flex flex-col space-y-4">
        ...
        <div className="flex flex-col">
          <label htmlFor="cardNumber" className="text-gray-700">Amount:$</label>
          <input
            disabled
            type="text"
            id="cardNumber"
